...
<form name="Customer Registration" action="RegisterCustomer.php" method="post">
<input type="text" name="firstname" placeholder="Forename" pattern=".{1,10}" required title="Enter First name">
<input type="text" name="surname" placeholder="Surname" pattern=".{1,10}" required title="Enter Surname">
<input type="text" name="address" placeholder="Address" pattern=".{1,20}" required title="Enter Address">
<input type="text" name="city" placeholder="City" pattern=".{1,15}" required title="Enter City">
<input type="text" name="postcode" placeholder="Postcode" pattern=".{1,7}" required title="Postcode">
<input type="text" name="phonenumber" placeholder="Phone" pattern=".{1,11}" required title="Phone">
